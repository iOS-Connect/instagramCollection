...
let clientID = "ea0f869ffa0747f395ccaa98ae751419"
let clientSecret = "59fdc6db770f4675bfba26ae10f0eff4"
let redirectURI = "popularcollections://"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  lazy var applicationDocumentsDirectory: NSURL = {
      // The directory the application uses to store the Core Data store file. This code uses a directory named "com.wigglingScholars.instagramCollection" in the application's documents Application Support directory.
  ...
  lazy var managedObjectModel: NSManagedObjectModel = {
      ...
      let modelURL = NSBundle.mainBundle().URLForResource("instagramCollection", withExtension: "momd")!
